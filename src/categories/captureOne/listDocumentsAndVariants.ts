...
const listDocumentsAndVariants: ScriptDefinition = {
  name: "listDocumentsAndVariants",
  description: "Retrieves a list of open Capture One documents and their variants in the current collection.",
  schema: {
    type: "object",
    properties: {},
    required: [],
...
export default listDocumentsAndVariants;
